...
public class RexTOpenAds implements LifecycleObserver, Application.ActivityLifecycleCallbacks {
    ...
    public RexTOpenAds(MyApplication myApplication) {
        RexTOpenAds.myApplication = myApplication;
        RexTOpenAds.myApplication.registerActivityLifecycleCallbacks(this);
